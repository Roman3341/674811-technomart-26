...
* Студент: [Роман Еременко](https://up.htmlacademy.ru/htmlcss/26/user/674811).
* Наставник: `Максим 17 Иванов`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/674811-technomart-26) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
